...
/*#include "/home/ed/.cache/wal/colors-wal-dwm.h"*/
...
static Key keys[] = {
	...
	{ ALTKEY,			XK_h,		focusmon,	{.i = -1 } },
	{ ALTKEY|ShiftMask,		XK_h,		tagmon,		{.i = -1 } },
	{ ALTKEY,			XK_l,	focusmon,	{.i = +1 } },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim ~/pictures/screenshots/$(date '+%y%m%d-%H%M-%S')-pic-full.png") },
